...
public class UIDevice {
    ...
    static let device: String = {
        ...
        func mapToDevice(identifier: String) -> String { // swiftlint:disable:this cyclomatic_complexity
            ...
            case "iPhone12,8":                                    return "iPhone"
            case "iPhone13,1":                                    return "iPhone"
            case "iPhone13,2":                                    return "iPhone"
            case "iPhone13,3":                                    return "iPhone"
            case "iPhone13,4":                                    return "iPhone"
            case "iPhone14,4":                                    return "iPhone"
            case "iPhone14,5":                                    return "iPhone"
            case "iPhone14,2":                                    return "iPhone"
            case "iPhone14,3":                                    return "iPhone"
            ...
            case "AppleTV6,2":                                    return "Apple TV"
